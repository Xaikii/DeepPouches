...
public class BetaPouchScreen extends AbstractContainerScreen<BetaPouchMenu> {
	...
	public BetaPouchScreen(BetaPouchMenu p_97741_, Inventory p_97742_, Component p_97743_) {
	...
	protected void renderBg(PoseStack p_97787_, float p_97788_, int p_97789_, int p_97790_) {
		...
		for (int k = slotsCount; k < slots.size(); k++) {
			Slot slot = slots.get(k);
			this.blit(p_97787_, i + slots.get(k).x - 1, j + slots.get(k).y - 1, 176, ((slot.index & k) % 4) * 18, 18,
					18);
		}
	}
